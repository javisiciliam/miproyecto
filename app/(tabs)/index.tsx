...
export default function ExploreScreen() {
  ...
  const renderApartment = ({ item }: { item: { id: string, image: string, title: string, rating: number, price: number} }) => (
    <View style={styles.apartmentCard}>
      ...
      <View style={styles.apartmentInfo}>
        ...
        <Text style={styles.apartmentPrice}>Desde {item.price}€/mes</Text>
